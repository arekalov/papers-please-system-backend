...
INSERT INTO participations (id, accepted, bonus_coefficient, penalty_coefficient, specialization, shift_id, user_id) VALUES ('662d84c1-0264-4a1f-a421-7a9c723846eb', false, 1.0, 0.0, 'PASSPORT', 'feefbbd1-f842-4c33-88c9-cf131aef0c78', 'ae3df3bc-77fe-436d-a2fb-e35426621451') ON CONFLICT DO NOTHING;
INSERT INTO participations (id, accepted, bonus_coefficient, penalty_coefficient, specialization, shift_id, user_id) VALUES ('1949de4d-2e9d-42c4-a181-edf02b08ce50', false, 1.0, 0.0, 'LOCALS', 'feefbbd1-f842-4c33-88c9-cf131aef0c78', 'ae3df3bc-77fe-436d-a2fb-e35426621451') ON CONFLICT DO NOTHING;
INSERT INTO participations (id, accepted, bonus_coefficient, penalty_coefficient, specialization, shift_id, user_id) VALUES ('534dd2e2-00ce-485e-87fa-3b5f06d89587', false, 1.0, 0.0, 'PASSPORT', '681b3a76-3860-4066-999f-f6b9f86b4468', 'ae3df3bc-77fe-436d-a2fb-e35426621451') ON CONFLICT DO NOTHING;
INSERT INTO participations (id, accepted, bonus_coefficient, penalty_coefficient, specialization, shift_id, user_id) VALUES ('a3267a39-be05-4796-aa2d-e3f929aca98a', false, 1.0, 0.0, 'PASSPORT', '9754d5d7-08d7-430c-a4c8-ece8ca62b53d', 'ae3df3bc-77fe-436d-a2fb-e35426621451') ON CONFLICT DO NOTHING;
INSERT INTO participations (id, accepted, bonus_coefficient, penalty_coefficient, specialization, shift_id, user_id) VALUES ('65d3ac38-2969-4b36-b4ed-9384b3cb0518', false, 1.0, 0.0, 'PASSPORT', '9754d5d7-08d7-430c-a4c8-ece8ca62b53d', 'f8c7eed2-5a92-4d6e-874b-8a9bf2e42a75') ON CONFLICT DO NOTHING;
